 ...
 */
public class Popup_Button extends FrameLayout {
     ...
     * @param contentParams
     */
    public Popup_Button(Context context, ViewGroup.LayoutParams layoutParams, int theme,
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            setTheme(Popup_Button.THEME_LIGHT);
            setPosition(Popup_Button.POSITION_BOTTOM_RIGHT);
        ...
        public Popup_Button build() {
            return new Popup_Button(context,
											layoutParams,
											theme,
											backgroundDrawable,
											position,
