...
public class Camera_s extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File saveFolder = new File(Environment.getExternalStorageDirectory(), "MaterialCamera");
        ...
        new MaterialCamera(this)                               // Constructor takes an Activity
                ...
                .iconStop(R.drawable.roundbuttoning)             // Sets a custom icon for the button used to stop recording
                .iconFrontCamera(R.drawable.mcam_camera_front)     // Sets a custom icon for the button used to switch to the front camera
                .iconRearCamera(R.drawable.mcam_camera_rear)       // Sets a custom icon for the button used to switch to the rear camera
                .iconPlay(R.drawable.list_play)              // Sets a custom icon used to start playback
